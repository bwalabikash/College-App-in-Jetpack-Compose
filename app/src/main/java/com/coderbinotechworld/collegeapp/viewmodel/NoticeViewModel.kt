...
import com.coderbinotechworld.collegeapp.utills.Constant.NOTICE
    ...
    fun saveNotice(uri: Uri, title: String, link: String) {
        ...
        uploadTask.addOnSuccessListener {
            imageRef.downloadUrl.addOnSuccessListener {
                saveNoticeUrl(it.toString(), randomUid, title, link)
            }
        }

    }

    private fun saveNoticeUrl(imageUrl: String, docId: String, title: String, link: String) {
